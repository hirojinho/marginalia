# Context — marginalia glossary

Canonical terms for the marginalia domain. This is a glossary, not a spec: it
...
A subject the learner studies — e.g. *Biology*, *Intro to Computer Science (cs101)*, *Algorithms*,
*History*, *Research*, plus *General* for the uncategorised. A small, fixed
set. Each Course has one **Plan**. The learner thinks "I'm doing cs101 now," and
...
("help me understand this paper from a course"), an interests review
