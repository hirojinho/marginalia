...
```json
{
  "original_name": "Biology Handbook.pdf",
  "pages_extracted": 12,
  "total_pages": 45,
  "content": {
    "1": "Title page text...",
...
**Data sources:** Course interests file, fleeting notes (if Biology), study plan progress.
