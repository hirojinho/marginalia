...
**Test:**
- Upload a PDF, then ask the agent "What does page 3 say about FMEA?"
...
**Test:**
- Ask the agent "What is fault tree analysis? Look it up on Wikipedia"
...
**Test:**
- In a CE-297 session, type "orient me on fault tree analysis"
- Verify the agent calls `study_skill` with `skill: "orientation"`, `params: {topic: "fault tree analysis", course_id: "ce297"}`
...
1. **Rebuild and restart:**
   ```bash
   cd /workspace/study-app && go build -o study-app . && ./study-app
   ```
...
2. **Test each tool individually:**
   ...
   - `study_skill`: In a CE-297 session, type "orient me on fault trees" → verify skill invocation

3. **Test tool chaining:**
   - "Orient me on FMEA, and look up the Wikipedia page for context"
