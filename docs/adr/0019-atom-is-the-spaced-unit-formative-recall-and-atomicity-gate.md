...
A review of two real study sessions (a cs101 session #62, a Biology session #63) on 2026-06-13 found
...
- `confidence_log` / `retrieval_queue` accreted **four incompatible id schemes**
  (bare integers, namespaced `task:cs101:20`, plan-task UUIDs, a base-UUID+suffix
