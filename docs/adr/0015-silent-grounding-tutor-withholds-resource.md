...
them into the chat. In a Biology session #41 (cellular respiration) the
tutor, in a single turn, asked for a prediction, *fabricated a prediction the
learner never gave*, and revealed the answer (the net ATP yield
figure); a turn later it dumped the entire pp.11–15 glycolysis/Krebs/electron-transport
taxonomy unprompted — after the learner had explicitly said "I'll be reading it
now." The learner never read anything; the tutor read it for them and lectured.
