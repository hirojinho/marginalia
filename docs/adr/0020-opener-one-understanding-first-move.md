...
Review of real sessions (DDIA #62, CE-297 #63) plus the learner's direct
...
(Rule 6 / the pretesting rule), and the pre-read prediction (Rule 7). DDIA #62
opened with ~12 question-exchanges (a 3-approach recall, **7 rounds** of
write-skew cueing, 3 pre-testing questions, a prediction) before a word was
read.
